function outputs = neurofeedbackAuditory(framesPath, syncBoxEnabled, outputFilePath, outputFileName, eegEnabled)
%
% Runs the static image localizer
%
% Example usage:
% neurofeedbackAuditory('../data/dynamic-images/', 1, 'C:\neurofeedback_protocols', 'AuditoryFeedbackPrt', 0)
% 
%  Inputs:
...
if nargin < 1
    ...
    if configs.fullscreen
        ...
        [configs.w, ~]=Screen('OpenWindow', screenNumber, 0, [100,100,800,600], 32, 2);
    end
    % ------------------
    ...
    logger.log('Auditory run started');
    ...
    outputs = imagery( configs, outputs, @auditoryInstruction, @computeAuditoryFeedback );
